...
public class ObjectUtils extends org.apache.commons.lang3.ObjectUtils {
    ...
    /**
     * 检查字符串类型是否为空,如果有空字符串，则返回true；否则，返回false
     * <pre>
     * ObjectUtils.checkEmptyString(null)              = true;
     * ObjectUtils.checkEmptyString("abc", "e", "")    = true;
     * ObjectUtils.checkEmptyString("ab", "cd", "ef")  = false;
     * </pre>
     * @param args
     * @return
     */
    public static boolean checkEmptyString(String... args) {
        for (String s : args) {
	...
	public static <T> T equalsToValue(T source, T base, T result) {
		return java.util.Objects.equals(source, base) ? result : source;
	}
	...
	public static <T> T notEqualsToValue(T source, T base, T result) {
		return java.util.Objects.equals(source, base) ? source : result;
	}
